...
urlpatterns = [
    ...
    # OurTeam
    path('get_our_team_by_id/<int:pk>/', OurTeamViewSet.as_view({'get': 'get_by_id'}), name='get_our_team_by_id'),
    ...
    # Events
    path('get_event_by_id/<int:pk>/', EventsViewSet.as_view({'get': 'get_by_id'}), name='get_event_by_id'),
    ...
    # Categories
    path('get_category_by_id/<int:pk>/', CategoriesViewSet.as_view({'get': 'get_by_id'}), name='get_category_by_id'),
    ...
    # Prices
    path('get_price_by_id/<int:pk>/', PricesViewSet.as_view({'get': 'get_by_id'}), name='get_price_by_id'),
    ...
    # AboutUs
    path('get_about_us_by_id/<int:pk>/', AboutUsViewSet.as_view({'get': 'get_by_id'}), name='get_about_us_by_id'),
    ...
    # Messages
    path('get_message_by_id/<int:pk>/', MessagesViewSet.as_view({'get': 'get_by_id'}), name='get_message_by_id'),
    ...
    # SocialMedias
    path('get_social_media_by_id/<int:pk>/', SocialMediasViewSet.as_view({'get': 'get_by_id'}),
    ...
    # WebSettings
    path('get_web_setting_by_id/<int:pk>/', WebSettingsViewSet.as_view({'get': 'get_by_id'}),
         name='get_web_setting_by_id'),
    ...
    # about us highlight
    path('get_about_us_highlight_by_id/<int:pk>/', AboutUsHighlightViewSet.as_view({'get': 'get_by_id'}),
         name='get_about_us_highlight_by_id'),
    ...
    # price highlight
    path('get_price_highlight_by_id/<int:pk>/', PriceHighlightViewSet.as_view({'get': 'get_by_id'}),
         name='get_price_highlight_by_id'),
    path('get_price_highlight/', PriceHighlightViewSet.as_view({'get': 'get'}), name='get_price_highlight'),
    path('create_price_highlight/<int:pk>/', PriceHighlightViewSet.as_view({'post': 'create'}),
         name='create_price_highlight'),
    ...
    # qr code
    path('get_qr_code_by_id/<int:pk>/', QRCodeViewSet.as_view({'get': 'get_by_id'}), name='get_qr_code_by_id'),
    ...
    # position
    path('get_position_by_id/<int:pk>/', DashboardPositionViewSet.as_view({'get': 'get_by_id'}),
